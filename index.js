...
//The nested function can access the variable internal because it is inside of the myFunction Scope.
...
function animalNames(data) {
  ...
  //     let scientific = item.scientific_name;

  //     return `name: ${name} , scientific: ${scientific}`;
  //   });
  // }
}
...
function lowPopulationAnimals(data) {
  const newnew = data.filter(function(item){
